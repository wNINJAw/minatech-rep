...
function Footer() {
  return (
    <>
      <section className="container-fluid fundoPcbVermelha final-cta">
        <div className="container-xxl">
          <div className="row">
            <div className="col-lg-6 col-sm-12 m-auto d-flex flex-column py-5 gap-4 justify-content-center align-items-center text-center">
              ...
              <a href="#queroParticipar" className="headerButton mb-4 mt-3">
                Faça parte agora
              </a>
            </div>
          </div>
      ...
      <footer className="container-fluid pt-5 fundoPreto">
        <div className="container-xxl d-flex flex-wrap justify-content-center">
          <div className="col-lg-6 col-sm-12">
            <img src="/img/minatech-logo.png" width="120" alt="" />
          ...
          <div className="col-lg-3 col-sm-6">
            ...
            <ul className="fs14pt footer-list">
              <li>Nossa missão</li>
              <li>O método</li>
              <li>A jornada</li>
