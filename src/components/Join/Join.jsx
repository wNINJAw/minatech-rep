    ...
    <section className="container-fluid" id="queroParticipar">
      <div className="container-xxl pt-4">
        ...
        <div className="row d-flex gap-5 justify-content-center">
          <div className="col-lg-5 col-sm-12 d-flex flex-column align-items-center px-5 py-4 fundoBranco br20">
          ...
          <div className="col-lg-5 col-sm-12 d-flex flex-column align-items-center px-5 py-4 br20 fundoGradientevermelho">
